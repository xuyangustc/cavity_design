...
double angle(const XYZ &p1, const XYZ &p2, const XYZ &p3, std::vector<XYZ> *deriv);
...
//get equation of a line in space by 2 points
//x = d0 + d1 * t
//y = d2 + d3 * t
//z = d4 + d5 * t
std::vector<double> eq_line(XYZ &c1, XYZ &c2);

//judge which is up and which is down, line_c1_c2, line_c3_c4
//return 0 - two lines do not have a point of intersection when projected in plane XOY
//return 1 - line_c1_c2 is upper
//return 2 - line_c3_c4 is upper
int projection(XYZ &c1, XYZ &c2, XYZ &c3, XYZ &c4);
}
